     ...
     h
         ...
         <nav class="navbar fixed-top navbar-expand-sm navbar-light bg-white">
           ...
           <div class="collapse navbar-collapse" id="mymenu">
             ...
             <li class="nav-item"><a href="setting.php" class="nav-link text-dark mr-5">SETTING</a></li>
             <li class="nav-item"><a href="logout_script.php" class="nav-link text-dark mr-5 ">LOGOUT</a></li>
             <li class="dropdown nav-item" style="margin-right: 80px">
                 <a class="dropdown-toggle nav-link text-dark mr-5" data-toggle="dropdown" href="#" >PROFILE
                 <span class="caret"></span></a>
                 <ul class="dropdown-menu p-2" >
                   <li><a class="text-danger"><?php echo $_SESSION['name']; ?></a></li>
                   <li><a class="text-primary"><?php echo $_SESSION['email']; ?></a></li>
                 </ul>
          </li>       
              ...
              <section class="team">
                 <div class="mycontainer">
                  <h1>Ready to HELP you!</h1>
                   ...
                   <div class="card">
                       <div class="box">
                           <img src="images/pb-3.jpg" alt="team img" />
                           <h4>ShriKrishna</h4>
                           <h5>Team member</h5>  
                       </div>
                   </div>
